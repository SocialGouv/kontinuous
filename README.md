...
get documentation of kontinuous cli
...
All charts are published and released as a chart repository at `https://socialgouv.github.io/kontinuous/`.
You can use it in your Chart.yaml as:

```yaml
dependencies:
  - repository: https://socialgouv.github.io/kontinuous/
    name: kontinuous
    version: "1"
```

`kontinuous` is the "umbrella hcart" (the main chart in helm jargon), it contain namespace, psp and all others components as subcharts, you can call all components from subkeys in your values, global remain at top.
